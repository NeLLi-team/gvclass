...
This directory contains container definitions for the GVClass `2.0.3` release image.
...
docker build -t gvclass:2.0.3 -f containers/docker/Dockerfile .
apptainer build --force gvclass_2.0.3.sif docker-daemon://gvclass:2.0.3
```
...
```text
library://nelligroup-jgi/gvclass/gvclass:2.0.3
```
...
apptainer push -U --library https://library.sylabs.io \
    gvclass.sif library://nelligroup-jgi/gvclass/gvclass:2.0.3
```
...
### Usage
```bash
docker run -v /path/to/data:/data gvclass:2.0.3 /data -t 32
```
