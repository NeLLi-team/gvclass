...
This directory contains container definitions for the GVClass `2.0.2` release image.
...
docker build -t gvclass:2.0.2 -f containers/docker/Dockerfile .
apptainer build --force gvclass_2.0.2.sif docker-daemon://gvclass:2.0.2
```
...
apptainer push -U --library https://library.sylabs.io \
    gvclass.sif library://nelligroup-jgi/gvclass/gvclass:2.0.2
```
...
### Usage
```bash
docker run -v /path/to/data:/data gvclass:2.0.2 /data -t 32
```
