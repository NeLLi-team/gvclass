...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--export-model", nargs="?", const="resources/contamination_model.joblib",
                        help="Retrain on full data and save model bundle to path (default: resources/contamination_model.joblib)")
