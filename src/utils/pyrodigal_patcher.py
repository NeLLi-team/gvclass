...
def patch_pyrodigal_genetic_codes():
    ...
    try:
        ...
        logger.debug("Marking pyrodigal as patched - codes 106/129 will use GeneticCodeHandler")
...
def patch_pyrodigal_translation():
    ...
    logger.debug("pyrodigal.GeneFinder is immutable - codes 106/129 will use GeneticCodeHandler")
    return True
