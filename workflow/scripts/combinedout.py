...
def combine_results(results: List[pd.DataFrame], combinedout: str) -> None:
    """
    ...
    df_results_f.to_csv(combinedout, sep='\t', index=False)
...
def main(resultsdirparent: str, combinedout: str) -> None:
    """
    ...
    combine_results(results, combinedout)
